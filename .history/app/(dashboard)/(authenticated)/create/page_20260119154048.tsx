    ...
    return (
        <Box style={{ height: '100%', width: '100%' }}>
            <Grid gutter="md" style={{ margin: 0, height: '100%' }}>
                ...
                <Grid.Col span={{ base: 12, md: 8 }} style={{ height: '100vh', display: 'flex', flexDirection: 'column', padding: '0.5rem' }}>
                    <ScrollArea 
                ...
                {/* Right Column - Output */}
                <Grid.Col span={{ base: 12, md: 4 }} style={{ height: '100vh', padding: '0.5rem' }}>
                    <Stack gap="md" pb="md">
