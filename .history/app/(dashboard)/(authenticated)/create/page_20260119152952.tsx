...
export default function ImageGeneratorPage() {
    ...
    return (
        <Container size="xl" py={0} h="100vh">
            <Grid gutter="md" h="100%">
                {/* Left Column - Input Data */}
                <Grid.Col span={{ base: 12, md: 8 }} style={{ height: '100%', display: 'flex', flexDirection: 'column', paddingTop: '1rem' }}>
                    <ScrollArea 
                ...
                {/* Right Column - Output */}
                <Grid.Col span={{ base: 12, md: 4 }} style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
