                                    ...
                                    >
                                        <Group gap="xs" wrap="nowrap">
                                            ...
                                            {allCharacters.map((character) => {
                                                const charTrainStatus = character.trainStatus || (character.isMarketplace ? 'completed' : 'untrained');
                                                const isUsable = charTrainStatus === 'completed';
                                                const isTrainingPending = charTrainStatus === 'pending';
                                                const needsTraining = charTrainStatus === 'untrained';
                                                ...
                                                <Card
                                                    ...
                                                    onClick={() => isUsable && setSelectedCharacter(character.id)}
                                                >
                                                    <Stack gap="xs">
                                                        <Box
                                                            style={{
                                                        ...
                                                        >
                                                            <img
                                                                ...
                                                                style={{
                                                                    ...
                                                                    height: '100%',
                                                                    objectFit: 'cover',
                                                                    filter: isUsable ? 'none' : 'grayscale(40%)',
                                                                }}
                                                            />
