    ...
    return (
        <Box style={{ height: '100%', width: '100%' }}>
            <Grid gutter="xs" style={{ margin: 0, height: '100%' }}>
                ...
                <Grid.Col span={{ base: 12, md: 8 }} style={{ display: 'flex', flexDirection: 'column', padding: '0.5rem' }}>
                    <ScrollArea
                ...
                {/* Right Column - Output */}
                <Grid.Col span={{ base: 12, md: 4 }} style={{ padding: '0.5rem', display: 'flex', flexDirection: 'column' }}>
