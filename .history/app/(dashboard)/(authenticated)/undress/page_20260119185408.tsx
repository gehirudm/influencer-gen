                        ...
                        <Box style={{ flex: 1, overflowY: 'auto', paddingRight: '8px' }}>
                            <Stack gap="md">
                                ...
                                <Box>
                                    ...
                                    <Group gap="md">
                                        {[
                                            { value: 'Undress', label: 'Undress', icon: IconShirt, image: '/undress/Undress.webp' },
                                            { value: 'X-ray', label: 'X-ray', icon: IconEye, image: '/undress/X-ray.webp' },
                                            { value: 'Bikini', label: 'Bikini', icon: IconSwimming, image: '/undress/Bikini.webp' },
                                            { value: 'Lingerie', label: 'Lingerie', icon: IconHanger, image: '/undress/Lingerie.webp' },                                            { value: 'Shibari', label: 'Shibari', icon: IconLink, image: '/undress/Shibari.webp' },                                        ].map((mode) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    />
                                                    <Stack align="center" gap={4} style={{ position: 'relative', zIndex: 1 }}>
                                                        <Icon size={20} color={selectedMode === mode.value ? 'white' : '#4a7aba'} />
