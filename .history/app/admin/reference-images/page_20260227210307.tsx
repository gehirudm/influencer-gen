...
const SEED_REFERENCE_IMAGES: Omit<ReferenceImage, 'id'>[] = [
  { name: 'Bathroom Mirror Selfie', image: '/character/premade characters/reference images/bathroom mirror selfie/0.webp', premium: false, order: 1, createdAt: new Date().toISOString() },
  { name: 'Spiderman cosplay', image: '/character/premade characters/reference images/spiderman cosplay/0.webp', premium: false, order: 2, createdAt: new Date().toISOString() },
  { name: 'Balcony at sunset', image: '/character/premade characters/reference images/balcony at sunset/0.webp', premium: false, order: 3, createdAt: new Date().toISOString() },
  { name: 'Yellow bikini', image: '/character/premade characters/reference images/Yellow bikini/0.webp', premium: false, order: 4, createdAt: new Date().toISOString() },
  { name: 'Kneeling', image: '/character/premade characters/reference images/kneeling/0.webp', premium: false, order: 5, createdAt: new Date().toISOString() },
  { name: 'Naked in bathtub', image: '/character/premade characters/reference images/Naked in bathtub/0.webp', premium: false, order: 6, createdAt: new Date().toISOString() },
  { name: 'School-style', image: '/character/premade characters/reference images/school-style/0.webp', premium: false, order: 7, createdAt: new Date().toISOString() },
  { name: 'Blowing a kiss', image: '/character/premade characters/reference images/blowing a kiss/0.webp', premium: false, order: 8, createdAt: new Date().toISOString() },
  { name: 'Gym fitness pose', image: '/character/premade characters/reference images/gym fitness pose/0.webp', premium: false, order: 9, createdAt: new Date().toISOString() },
  { name: 'Picnic lifestyle', image: '/character/premade characters/reference images/picnic lifestyle/0.webp', premium: false, order: 10, createdAt: new Date().toISOString() },
  { name: 'Cop Girl Cosplay 2', image: '/character/premade characters/reference images/Premium-reference-img/cop girl cosplay 2.webp', premium: true, order: 11, createdAt: new Date().toISOString() },
  { name: 'Countertop Arch Pose', image: '/character/premade characters/reference images/Premium-reference-img/Countertop Arch Pose.webp', premium: true, order: 12, createdAt: new Date().toISOString() },
  { name: 'Holding Chest', image: '/character/premade characters/reference images/Premium-reference-img/holding chest.webp', premium: true, order: 13, createdAt: new Date().toISOString() },
  { name: 'Kneeling Couch Lean', image: '/character/premade characters/reference images/Premium-reference-img/Kneeling Couch Lean.webp', premium: true, order: 14, createdAt: new Date().toISOString() },
  { name: 'Leaning Forward', image: '/character/premade characters/reference images/Premium-reference-img/leaning forward.webp', premium: true, order: 15, createdAt: new Date().toISOString() },
  { name: 'Lying on Beach', image: '/character/premade characters/reference images/Premium-reference-img/lying on beach.webp', premium: true, order: 16, createdAt: new Date().toISOString() },
  { name: 'Naked Tongue Out', image: '/character/premade characters/reference images/Premium-reference-img/naked tongue out.webp', premium: true, order: 17, createdAt: new Date().toISOString() },
  { name: 'Pregnant Pose', image: '/character/premade characters/reference images/Premium-reference-img/pregnant pose.webp', premium: true, order: 18, createdAt: new Date().toISOString() },
  { name: 'Santa Outfit', image: '/character/premade characters/reference images/Premium-reference-img/santa outfit.webp', premium: true, order: 19, createdAt: new Date().toISOString() },
  { name: 'Showing Feet', image: '/character/premade characters/reference images/Premium-reference-img/showing feet.webp', premium: true, order: 20, createdAt: new Date().toISOString() },
  { name: 'Tight Clothes', image: '/character/premade characters/reference images/Premium-reference-img/tight clothes.webp', premium: true, order: 21, createdAt: new Date().toISOString() },
  { name: 'Velma Cosplay', image: '/character/premade characters/reference images/Premium-reference-img/velma cosplay.webp', premium: true, order: 22, createdAt: new Date().toISOString() },
  { name: 'Wearing Hijab', image: '/character/premade characters/reference images/Premium-reference-img/wearing hijab.webp', premium: true, order: 23, createdAt: new Date().toISOString() },
  { name: 'Yoga', image: '/character/premade characters/reference images/Premium-reference-img/yoga.webp', premium: true, order: 24, createdAt: new Date().toISOString() },
];
  ...
  const FormContent = useMemo(
    () => (
      <Stack gap="md">
        <TextInput
          label="Name"
          placeholder="Reference image name (also used as prompt)"
          value={formData.name}
