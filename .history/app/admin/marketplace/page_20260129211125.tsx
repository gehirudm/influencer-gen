...
// Character form component moved outside to prevent re-creation on every render
function CharacterForm({ 
  formData, 
  setFormData 
}: { 
  formData: Partial<MarketplaceCharacter>;
  setFormData: (data: Partial<MarketplaceCharacter>) => void;
}) {
  return (
    <Stack gap="md">
      <TextInput
  ...
  return (
    <Box style={{ padding: '0.75rem', height: '100%' }}>
      ...
      <Modal
        ...
        centered
      >
        <CharacterForm formData={formData} setFormData={setFormData} />
