...
import { IconUsers, IconX, IconEdit, IconTrash, IconPlus, IconUpload } from '@tabler/icons-react';
...
// Initial dummy data
const initialCharacters: MarketplaceCharacter[] = [
  {
    id: '1',
    name: 'Sophia',
    age: 24,
...
export default function AdminMarketplacePage() {
  const [characters, setCharacters] = useState<MarketplaceCharacter[]>(initialCharacters);
  ...
  const handleDelete = (character: MarketplaceCharacter) => {
  ...
  const handleSaveEdit = () => {
    ...
    setCharacters(characters.map(c => 
      c.id === editingCharacter.id 
        ? { ...editingCharacter, ...formData } as MarketplaceCharacter
        : c
    ));
  ...
  const handleCreateNew = () => {
    ...
    const newCharacter: MarketplaceCharacter = {
