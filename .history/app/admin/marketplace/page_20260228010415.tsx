  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      await updateDoc(characterRef, {
        ...
        loraKeyword: formData.loraKeyword || '',
      });
  ...
  const CharacterForm = useMemo(() => (
    <Stack gap="md">
      ...
      <TextInput
        ...
        description="Trigger keyword for the LoRA model — prepended to prompts during image generation"
        value={formData.loraKeyword}
        onChange={(e) => setFormData(prev => ({ ...prev, loraKeyword: e.target.value }))}
      />
