            ...
            <Group gap="sm" grow align="stretch">
              <Card padding="sm" radius="md" style={{ backgroundColor: '#0a0a0a', border: '1px solid #333' }}>
                <Group gap="xs">
                  ...
                  <div>
                    <Text size="xs" c="dimmed">Exclusive Claims</Text>
                    <Text size="lg" fw={700} c="violet">{exclusiveClaims}</Text>
                  </div>
                </Group>
              </Card>
              <Card padding="sm" radius="md" style={{ backgroundColor: '#0a0a0a', border: '1px solid #333' }}>
                <Group gap="xs">
                  ...
                  <div>
                    <Text size="xs" c="dimmed">Licenses</Text>
                    <Text size="lg" fw={700} c="blue">{licensePurchases}</Text>
                  </div>
                </Group>
              </Card>
              <Card padding="sm" radius="md" style={{ backgroundColor: '#0a0a0a', border: '1px solid #333' }}>
                <Group gap="xs">
                  <IconCoins size={20} color="#22C55E" />
                  <div>
                    <Text size="xs" c="dimmed">Total</Text>
                    <Text size="lg" fw={700} c="green">{purchases.length}</Text>
                  </div>
                </Group>
              </Card>
            </Group>
