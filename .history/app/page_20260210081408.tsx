...
function CharacterCard(character: CharacterCardData) {
  return (
    <div className="flex flex-col">
      ...
      <Link 
        href={`/generate-images?cid=${character.cid || ''}`}
      ...
      <div className="bg-black py-20">
        <div className="max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-300 mb-6">
            World's largest collection ready to use. Start creating immediately.
          </p>

          <div className="flex justify-center mb-16">
            <Link href="/marketplace" className="flex items-center text-lg text-indigo-400 hover:text-indigo-300 transition">
              Browse Models
