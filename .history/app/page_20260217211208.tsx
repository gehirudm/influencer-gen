      ...
      <div className="relative min-h-screen bg-black overflow-hidden">
        ...
        <div className="absolute left-40 top-1/2 -translate-y-1/2 z-0 hidden lg:block">
          <div className="relative w-64 h-[400px]">
            ...
            {/* Bottom Left Image */}
            <div 
              className="absolute top-32 left-0 w-48 h-64 rounded-2xl overflow-hidden shadow-2xl z-0"
        ...
        <div className="absolute right-40 top-1/2 -translate-y-1/2 z-0 hidden lg:block">
          <div className="relative w-64 h-[400px]">
            ...
            {/* Bottom Right Image */}
            <div 
              className="absolute top-32 right-0 w-48 h-64 rounded-2xl overflow-hidden shadow-2xl z-0"
              style={{ transform: 'rotate(-8deg) translateY(0px)' }}
            >
              <img
