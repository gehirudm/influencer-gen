  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative min-h-screen bg-black overflow-hidden">
        ...
        <div className="absolute left-20 top-1/2 -translate-y-1/2 z-0 hidden lg:block">
        ...
        <div className="absolute right-20 top-1/2 -translate-y-1/2 z-0 hidden lg:block">
          <div className="relative w-64 h-[600px]">
            {/* Top Right Image */}
            <div 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-12">
            ...
            <div className="backdrop-blur-xl bg-white/5 rounded-2xl p-8 border border-white/10 hover:border-indigo-500/50 transition">
              ...
              <button
                onClick={() => router.push("/pricing")}
                className="w-full bg-gradient-to-r from-indigo-600 via-indigo-500 to-violet-600 hover:from-indigo-700 hover:via-indigo-600 hover:to-violet-700 text-white py-3 rounded-xl text-base font-semibold transition shadow-lg shadow-indigo-500/30"
              >
                Get Started
              </button>
            </div>
