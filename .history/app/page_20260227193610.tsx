  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative min-h-screen bg-black overflow-x-clip">
        ...
        <div className="relative z-10 flex items-start md:items-center justify-center min-h-screen">
          <div className="text-center px-8 pt-28 md:pt-0 max-w-3xl pb-16 md:pb-0">
            ...
            <div className="flex gap-3 overflow-x-auto mt-8 pb-2 lg:hidden snap-x snap-mandatory -mx-4 px-4" style={{ scrollbarWidth: 'none' }}>
              {[
