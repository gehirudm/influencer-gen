    ...
    return (
        <Container size="xl" py={{ base: 'md', md: 'xl' }}>
            ...
            <Text ta="center" size="lg" c="dimmed" mb={{ base: 'md', md: 'xl' }} maw={800} mx="auto">
                Create, manage, and reuse characters for your stories, conversations, and scenes. 
                Start from scratch or choose a premade character and customize it to fit your world.
            </Text>
